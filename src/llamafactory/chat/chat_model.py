...
class ChatModel:
    ...
    def __init__(self, args: Optional[dict[str, Any]] = None) -> None:
        ...
        # Enforce HF backend when multi-scale vision is requested, since only HF path installs wrappers
        if getattr(model_args, "use_multi_scale", False) and model_args.infer_backend != EngineName.HF:
            raise ValueError("use_multi_scale=True requires infer_backend=HF. Please set --infer_backend hf or disable use_multi_scale.")
