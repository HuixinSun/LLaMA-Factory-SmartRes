...
class FinetuningArguments(
    ...
    selector_learning_rate: Optional[float] = field(
        default=None,
        metadata={
            "help": (
                "Separate learning rate for MTS selector modules (scale_head, text_visual_projector, encoder_patch_proj). "
                "If not set, uses the default learning_rate for all parameters."
            )
        },
    )
