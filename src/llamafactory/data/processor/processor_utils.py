...
def infer_seqlen(source_len: int, target_len: int, cutoff_len: int) -> tuple[int, int]:
    ...
    if target_len * 2 < cutoff_len:  # truncate source # source_len: The original length of the source sequence (e.g., input text or image tokens).
        max_target_len = cutoff_len
    elif source_len * 2 < cutoff_len:  # truncate target # target_len: The original length of the target sequence (e.g., output text or labels).
